...
public class AuthenticationController {
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthenticationRequestDto request) {
        try {
            ...
            User user = userRepository.findByEmail(request.getEmail()).orElseThrow(() -> new UsernameNotFoundException("Uer doen't exit"));
            ...
            return new ResponseEntity<>("Invalid email paword combination", HttpStatus.FORBIDDEN);
        }
    }
